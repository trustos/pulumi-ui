/**
 * Starter cards define pre-configured deployment starters.
 * Each card maps to a blueprint + pre-selected applications with
...
export interface StarterCard {
  ...
  blueprint: string; // blueprint name (e.g., "nomad-cluster")
  applications: string[]; // app keys to pre-select
  userFields: StarterField[];
...
// -- Starter: Nomad Cluster (infra only) -------------------------------------

const nomadClusterStarter: StarterCard = {
  id: "nomad-cluster",
  name: "Nomad Cluster",
  description:
