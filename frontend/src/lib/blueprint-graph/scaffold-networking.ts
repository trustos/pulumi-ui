import type { BlueprintGraph, ResourceItem } from '$lib/types/blueprint-graph';
 ...
 */
export function hasNetworkingResources(graph: BlueprintGraph): boolean {
...
/**
 * Adds VCN + IGW + Route Table + Subnet resources to a BlueprintGraph
 ...
 */
export function scaffoldNetworkingGraph(graph: BlueprintGraph): BlueprintGraph {
