...
/**
 * Renames a resource across the entire ProgramGraph:
 ...
 */
export function propagateRename(graph: ProgramGraph, oldName: string, newName: string): ProgramGraph {
  ...
  function processItems(items: ProgramItem[]): ProgramItem[] {
